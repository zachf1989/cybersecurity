...
object logappend
    ...
    /* TRY TO READ A BATCH FILE AND PROCESS COMMANDS */
    ...
    /* PROCESS A SINGLE LINE OF A BATCH FILE */
    ...
    /* ADD GALLERY TO THE LIST OF FILES TO BE WRITTEN */
    ...
    /* TRY TO MAKE CHANGES TO THE GALLERT */
	def editGallery (obj: Gallery, args: Array[String]) =
		...
		if (timestamp > obj.timestamp && timestamp < 1073741824 && hasK && (hasE || hasG) && (hasA || hasL))
			{
